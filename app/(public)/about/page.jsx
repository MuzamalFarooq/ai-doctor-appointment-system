...
export default function AboutPage() {
  return (
    <div className="min-h-screen pt-20">
      {/* Hero */}
      <div className="bg-gradient-to-br from-primary-600 via-accent-500 to-teal-500 text-white py-24">
      ...
      <div className="max-w-5xl mx-auto px-4 -mt-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {STATS.map(({ value, label, icon }) => (
            <div key={label} className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 text-center shadow-card">
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {VALUES.map(({ icon: Icon, title, desc, color }) => (
            <div key={title} className="flex gap-4 p-6 bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-accent-500 py-16">
        <div className="max-w-3xl mx-auto px-4 text-center text-white">
          ...
          <p className="text-white/80 mb-8">Join thousands of patients who have already discovered the future of healthcare.</p>
