...
export default function AuthLayout({ children }) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-950 via-gray-900 to-accent-950 flex items-center justify-center p-4 relative overflow-hidden">
