    ...
    <footer className="bg-gray-950 text-gray-300 mt-20 sm:mt-24 border-t border-gray-900">
      ...
      <div className="border-b border-gray-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="bg-gradient-to-r from-primary-900/60 to-accent-900/60 rounded-3xl p-8 sm:p-10 lg:p-14 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 border border-primary-800/50 shadow-2xl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 lg:gap-12">
          {/* Brand Column */}
          <div className="sm:col-span-2 md:col-span-3 lg:col-span-2 pr-0 lg:pr-6">
          ...
          {Object.entries(footerLinks).map(([section, links]) => (
            <div key={section} className="space-y-4">
              <h4 className="text-white font-semibold text-xs sm:text-sm uppercase tracking-wider mb-6">
        ...
        {/* App Store & Trust Badges */}
        <div className="border-t border-gray-800/80 mt-16 sm:mt-20 pt-12 sm:pt-16">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 sm:gap-6">
              <a href="#" className="flex items-center gap-3.5 bg-gray-900 hover:bg-gray-800 border border-gray-800 text-white px-5 py-3.5 rounded-xl transition-all hover:border-gray-700">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
              {['HIPAA Compliant', 'ISO 27001', 'SSL Secured', 'PMC Verified'].map(badge => (
                <div key={badge} className="flex items-center gap-2 bg-gray-900/90 border border-gray-800 px-3.5 py-2 rounded-xl">
